...
class RyuRedirect(app_manager.RyuApp):
    ...
    def packet_in_handler(self, ev):
        ...
        # Redirect logic: All traffic from Client (03) to Server1 (01) -> redirect to Server2 (02)
        if src == '00:00:00:00:00:03':  # Client MAC
            is_to_server1 = (dst == '00:00:00:00:00:01') or (dst_ip == '10.0.1.2')
            
            if is_to_server1 and '00:00:00:00:00:02' in self.mac_to_port[dpid]:  # Server2 MAC learned
                out_port = self.mac_to_port[dpid]['00:00:00:00:00:02']
                self.logger.info("Redirect: Client traffic to Server1 (dst=%s, dst_ip=%s) redirected to Server2 on port %s", 
                               dst, dst_ip, out_port)
